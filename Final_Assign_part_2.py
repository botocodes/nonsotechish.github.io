...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unempl_eff= recession_data.groupby(['Vehicle_Type', 'Automobile_Sales'])['unemployment_rate'].mean().reset_index()
        R_chart4  = dcc.Graph(figure=px.bar(unempl_eff,
        x= 'unemployment_rate',
        y= 'Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Tot_sal= yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(Tot_sa,
        x='Month',
        y='Automobile_Sales',
        title="Total Monthly Automobilr Sales"))
